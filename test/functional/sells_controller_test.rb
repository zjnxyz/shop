...
class SellsControllerTest < ActionController::TestCase
  ...
  test "should create sell" do
    assert_difference('Sell.count') do
      post :create, sell: { actual_sum: @sell.actual_sum, amount: @sell.amount, remark: @sell.remark, sum: @sell.sum }
    end
  ...
  test "should update sell" do
    put :update, id: @sell, sell: { actual_sum: @sell.actual_sum, amount: @sell.amount, remark: @sell.remark, sum: @sell.sum }
    assert_redirected_to sell_path(assigns(:sell))
  end
